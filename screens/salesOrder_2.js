...
class salesOrder_2 extends Component {
    ...
    componentDidMount() {
        this.setState({
            ...
            From_Company: this.props.navigation.state.params.FROM_CMPNY,
            Gst_No: this.props.navigation.state.params.GST_NO,
            Date: this.props.navigation.state.params.DATE,
            Material_List_New: this.props.navigation.state.params.MATERIALlIST,
            Material_List_Old: this.props.navigation.state.params.MATERIALlIST,
